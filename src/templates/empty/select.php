...
?>
      <hr>
        ...
        │<br>
      ├ <b>Speed:</b> <?php echo formatLargeNumbers($metadata_current[0]['hashrate'], $pool_configuration['math_precision']).$pool_configuration['hashrate_unit']; ?> |
      <b>Algorithm:</b> <?php echo $server_configuration['algorithm']; ?> |
      <b>Miners:</b> <?php echo $metadata_current[0]['miners']; ?> / <b>Workers:</b> <?php echo $metadata_current[0]['workers']; ?> |
      ...
      <br>
      └ <b>Network:</b> <?php echo formatLargeNumbers(($network_current[0]['hashrate'] * $pool_configuration['network_hashrate_multiplier']), $pool_configuration['math_precision']).$pool_configuration['hashrate_unit'];?>
